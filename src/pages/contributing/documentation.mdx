...
```mdx filename="_meta.ts"
// pages/guide/_meta.ts
export default {
    installation: 'Installation Guide',
    setup: 'Setup Instructions',
    newtopic: 'New Topic Documentation', // Add your new page here
};
```
...
export default {
    index: 'Home',
    guide: {
        _meta: import('./guide/_meta'),     // Reference the guide metadata
        'new-section': 'New Section Title', // Optional additional pages
    },
    api: 'API Reference',
};
```
...
export default {
    ...
    tutorials: {
        _meta: import('./tutorials/_meta'), // Add reference to the new section
    },
    api: 'API Reference',
};
```
