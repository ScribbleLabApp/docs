...
/**
 * Cimg component - A React functional component for rendering images from Cloudinary.
 *
 ...
 * @example
 * // Usage example
 * <Cimg id="sample-image" alt="Sample Image" className="custom-class" />
 */
const Cimg = ({
  id,
  alt,
  ...
  if (!id || !alt) {
    console.error(
      'The "id" and "alt" props are required for the <Cimg> component.'
    );
    return null;
  }
